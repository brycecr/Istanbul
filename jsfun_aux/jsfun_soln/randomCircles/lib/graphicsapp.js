 ...
 * ----------------------------
 * Calculates the user's current location, and, if successful, calls successFn, passing
 ...
 * }
 *
 * If geolocation is not successful, errorFn is called.
 *
 * Parameters:
 * -----------
 * successFn: the function that's called once the user's location has been successfully calculated
 * errorFn: the error callback function
 */
GraphicsApp.prototype.getCurrentLocation = function(successFn, errorFn) {
